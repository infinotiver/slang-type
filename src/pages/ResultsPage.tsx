  ...
  return (
    <div className="flex-1 overflow-y-auto bg-background text-foreground flex flex-col font-mono px-4 sm:px-6">
      <div className="w-full">
        ...
        {rejectReason && (
          <div className="px-4 text-xs text-red-400 font-mono bg-secondary p-3 rounded-2xl mb-4">
            {rejectReason}
          </div>
        )}
        ...
        <div className="flex flex-col md:flex-row gap-6">
          <div className="lg:w-48 flex flex-col gap-6 shrink-0">
            <div className="p-6 bg-highlight/10 rounded-2xl flex flex-col justify-between min-h-55">
              {/* Upper Stats */}
        ...
        <div className="mt-6 grid grid-cols-2 lg:grid-cols-4 gap-4 auto-rows-fr">
          <div className="p-4 border border-secondary/30 rounded-2xl bg-secondary flex flex-col">
